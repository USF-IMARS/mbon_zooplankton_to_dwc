...
taxa_full <-
   ...
   mutate(
       scientificNameID = str_replace(scientificNameID, ":(\\d+)", 
                                       glue(":{valid_aphia_id}"))
   )  %>%
     relocate(scientificName, scientificNameID, .after = lifestage)
...
filter(occur, is.na(scientificNameID)) %>%
