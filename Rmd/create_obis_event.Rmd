...
"net_size",                           "",                      "",                NA,         "metres", "P06/current/ULAA/",                NA,
...
"split_amount",                   "",                     "",                 NA,            "decimal",                    NA,               NA,
"splits_analyzed",                "",                     "",                 NA,                   NA,                    NA,               NA, 
# "filtered_volume_m3"
"volume_filt_cubic_m",            "",                     "",                NA,     "per cubic metre",                    NA,               NA, 
"pipette_vol_m_l",                "",                     "",                NA,          "milliliter",                    NA,               NA,               
"mean_ind_dil_factor",            "",                     "",                NA,                    NA,                    NA,               NA, 
...
"number_ind_sample",              "",                     "",                NA,                    NA,                     NA,              NA, 
"tow_speed",                      "",                     "",                NA,                    NA,                     NA,              NA, 
"split_size",                     "",                     "",                NA,                    NA,                     NA,              NA, 
"tow_speed_cm_sec",               "",                     "",                NA,                    NA,                     NA,              NA, 
...
names(taxa_matched_merg)[names(taxa_matched_merg) %in% MoF1$orig_term]

MoF1$orig_term[!MoF1$orig_term %in% names(taxa_matched_merg)]
...
left_join(event, location) %>%
    write_csv(file = glue("{path}/event.csv"), na = "")

occur %>%
    write_csv(file = glue("{path}/occur.csv"), na = "")

MoF %>%
    write_csv(file = glue("{path}/mof.csv"), na = "")
