...
This creates an image of cruises where zooplankton was collected in years and
months. 
...
plt_heat_main <- 
    ...
    filter(str_detect(locationID, "LK|MR|WS") & !is.na(mesh) & mesh > 100) %>%
    ...
    geom_text(aes(label = present), family = "serif") +
    labs(
