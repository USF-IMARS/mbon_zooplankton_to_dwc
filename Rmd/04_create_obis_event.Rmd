...
mof_info$mof_occur <-
  ...
  # ---- filter for unique eventIDs and occurenceIDs
  distinct(eventID, occurrenceID, .keep_all = TRUE) %>%
    
  # ---- select `occurence` mof variables     
  select(
    eventID, occurrenceID,
    filter(mof_info$mof_base, str_detect(event_occur, "occur"))$orig_term
  ) %>%

  # ---- convert to long format based on eventID and occurenceID
  pivot_longer(
...
# ============================================================================ #
# ---- Merge Event and Occurence MoF with MoF Base ----
# ============================================================================ #    
mof_core <-
  bind_rows(
    mof_info$mof_occur,
 ...
 select(-orig_term, -event_occur) %T>% print()
...
# events <- unique(event_core$eventID)
